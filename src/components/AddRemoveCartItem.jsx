...
export class AddRemoveCartItem extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { quantity, handleAddCart } = this.state;
    return (
      <div>
        <h5>Quantidade</h5>
        ...
        <input type="button" value="Adicionar ao Carrinho" onClick={() => handleAddCart(quantity)} />
      </div>
    );
  }
}
